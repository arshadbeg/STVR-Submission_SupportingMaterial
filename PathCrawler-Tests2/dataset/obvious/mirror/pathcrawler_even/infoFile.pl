...
:- heading:setval_file_name('even.c').
:- heading:setval_base_name('even').
:- heading:setval_pathcrawler_directory('pathcrawler_even').
:- heading:setval_trace_directory('pathcrawler_trace_even').
...
local_var('__tmp_lin_0', 'isEven', i(si(4))).
local_var('tmp', 'main', p(i(si(1)))).
local_var('__tmp_lin_2', 'main', i(si(4))).
local_var('__tmp_lin_1', 'main', p(i(si(1)))).
...
formal_param('return value', 'isEven', 0, i(si(4))).
formal_param('n', 'isEven', 1, i(si(4))).
