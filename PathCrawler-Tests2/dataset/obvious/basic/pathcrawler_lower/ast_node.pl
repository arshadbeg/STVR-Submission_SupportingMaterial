...
ast_node(n(2), seq, [114]). % lower.c: l.4
ast_node(123, return, ['__retres']). % lower.c: l.11
ast_node(101, seq, []). % FRAMAC_SHARE/pc/lib/lanceur_deb.h: l.83
ast_node(fun(168), func, ['__FC_assert', 4, 0, 0, 101]). % FRAMAC_SHARE/pc/lib/lanceur_deb.h: l.79
ast_node(fun(177), func, ['toLowerCase', 1, 0, 0, 105]). % lower.c: l.2
ast_node(121, call, ['toLowerCase', 'str']). % lower.c: l.10
ast_node(105, seq, [106,n(1)]). % lower.c: l.3
ast_node(115, assign, ['i', +(i(si(4)),'i',c(1,i(si(4))))]). % lower.c: l.3
ast_node(122, assign, ['__retres', c(0,i(si(4)))]). % lower.c: l.11
ast_node(fun(181), func, ['main', 0, 0, 1, 119]). % lower.c: l.8
ast_node(119, seq, [120,121,122,123]). % lower.c: l.9
ast_node(109, cond, [diff, cast(i(si(4)),e(+(p(i(si(1))),'str','i'),c(0,i(si(4))))), c(0,i(si(4)))]). % lower.c: l.3
ast_node(114, assign, [e(+(p(i(si(1))),'str','i'),c(0,i(si(4)))), cast(i(si(1)),+(i(si(4)),cast(i(si(4)),e(+(p(i(si(1))),'str','i'),c(0,i(si(4))))),c(1,i(si(4)))))]). % lower.c: l.4
ast_node(106, assign, ['i', c(0,i(si(4)))]). % lower.c: l.3
ast_node(n(3), seq, [115]). % lower.c: l.3
ast_node(103, return, []). % FRAMAC_SHARE/pc/lib/lanceur_deb.h: l.85
ast_node(117, return, []). % lower.c: l.6
...
ast_node(120, seq, [i(1),i(2),i(3),i(4),i(5),i(6),i(7),i(8),i(9),i(10),i(11),i(12),i(13)]). % lower.c: l.9
...
stmt_location(121, 'lower.c', 10).
stmt_location(105, 'lower.c', 3).
stmt_location(115, 'lower.c', 3).
stmt_location(122, 'lower.c', 11).
stmt_location(fun(181), 'lower.c', 8).
stmt_location(119, 'lower.c', 9).
