...
:- heading:setval_file_name('mirror.c').
:- heading:setval_base_name('mirror').
:- heading:setval_pathcrawler_directory('pathcrawler_mirror').
:- heading:setval_trace_directory('pathcrawler_trace_mirror').
...
local_var('reversed', 'mirrorSum', i(si(4))).
local_var('temp', 'mirrorSum', i(si(4))).
local_var('__retres', 'mirrorSum', i(si(4))).
...
formal_param('return value', 'mirrorSum', 0, i(si(4))).
formal_param('n', 'mirrorSum', 1, i(si(4))).
