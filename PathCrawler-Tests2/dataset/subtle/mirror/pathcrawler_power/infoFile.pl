...
:- heading:setval_file_name('power.c').
:- heading:setval_base_name('power').
:- heading:setval_pathcrawler_directory('pathcrawler_power').
:- heading:setval_trace_directory('pathcrawler_trace_power').
...
local_var('__tmp_lin_0', 'isPowerOfTwo', i(si(4))).
local_var('__tmp_lin_1', 'main', i(si(4))).
local_var('testValues', 'main', t(i(us(4)),15)).
...
formal_param('return value', 'isPowerOfTwo', 0, i(si(4))).
formal_param('n', 'isPowerOfTwo', 1, i(us(4))).
