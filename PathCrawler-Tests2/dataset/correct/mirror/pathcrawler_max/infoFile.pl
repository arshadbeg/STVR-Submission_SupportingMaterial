...
local_var('__tmp_lin_0', 'max', i(si(4))).
local_var('__tmp_lin_1', 'main', i(si(4))).
local_var('testCases', 'main', t(t(i(si(4)),2),5)).
...
formal_param('return value', 'max', 0, i(si(4))).
formal_param('a', 'max', 1, i(si(4))).
formal_param('b', 'max', 2, i(si(4))).
