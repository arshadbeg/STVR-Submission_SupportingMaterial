...
create_input_vals('gcd',Ins):-
  create_input_val('b',int([-2147483648..2147483647]),Ins),
  create_input_val('a',int([-2147483648..2147483647]),Ins),
  true.
% add new variable domain e.g.:
%  create_input_val(yourVarName,int([min..max]),Ins), 


unquantif_preconds('gcd',[]).

quantif_preconds('gcd',[]).
