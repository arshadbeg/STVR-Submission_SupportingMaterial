...
void pathcrawler_call_fonction(void){
      #define main pathcrawler___main
      pathcrawler__retres__findMode = findMode(arr, size);
#undef main
}

void pathcrawler_call_oracle(void){
      oracle_findMode(Pre_arr, arr, size, pathcrawler__retres__findMode);
}
