...
stmt_location(271, 'tritype.c', 8, 0).
stmt_location(281, 'tritype.c', 10, 0).
stmt_location(fun(179), 'tritype.c', 2, 0).
stmt_location(241, 'tritype.c', 3, 0).
stmt_location(274, 'tritype.c', 8, 0).
stmt_location(255, 'tritype.c', 5, 0).
stmt_location(279, 'tritype.c', 9, 0).
stmt_location(n(12), 'tritype.c', 7, 0).
stmt_location(fun(170), 'FRAMAC_SHARE/pc/lib/lanceur_deb.h', 79, 0).
stmt_location(256, 'tritype.c', 5, 0).
stmt_location(270, 'tritype.c', 7, 0).
stmt_location(291, 'tritype.c', 13, 0).
stmt_location(289, 'tritype.c', 12, 0).
stmt_location(243, 'tritype.c', 4, 1).
stmt_location(257, 'tritype.c', 6, 1).
stmt_location(262, 'tritype.c', 6, 2).
stmt_location(276, 'tritype.c', 9, 0).
stmt_location(248, 'tritype.c', 4, 2).
stmt_location(251, 'tritype.c', 4, 3).
stmt_location(265, 'tritype.c', 6, 3).
stmt_location(284, 'tritype.c', 10, 0).
stmt_location(269, 'tritype.c', 7, 0).
stmt_location(242, 'tritype.c', 3, 0).
stmt_location(286, 'tritype.c', 11, 0).
