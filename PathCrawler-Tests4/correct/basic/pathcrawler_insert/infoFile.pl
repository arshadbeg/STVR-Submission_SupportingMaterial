...
user_type(2,s('Node', [f('data',i(si(4)),0), f('next',p(user(2)),8)]),16).
user_type(0,0,0).

local_var('__tmp_lin_0', 'insertAtHead', i(si(4))).
local_var('newNode', 'insertAtHead', p(user(2))).
local_var(0,0,0).
...
formal_param('return value', 'insertAtHead', 0, p(user(2))).
formal_param('head', 'insertAtHead', 1, p(user(2))).
