...
ast_node(590, cond, [sup, n, c(4, i(si(4)))]).
...
ast_node(697, cond, [inf, +(i(si(4)), top, c(2, i(si(4)))), *(i(si(4)), c(4, i(si(4))), c(2, i(si(4))))]).
...
ast_node(686, cond, [inf, +(i(si(4)), top, c(2, i(si(4)))), *(i(si(4)), c(4, i(si(4))), c(2, i(si(4))))]).
