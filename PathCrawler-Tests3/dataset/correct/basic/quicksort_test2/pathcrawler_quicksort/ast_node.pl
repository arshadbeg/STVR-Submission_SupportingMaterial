...
ast_node(719, assign, ['n', c(3,i(si(4)))]). % quicksort.c: l.75
...
ast_node(711, cond, [inf, 'i', c(3,i(si(4)))]). % quicksort.c: l.72
...
ast_node(590, cond, [sup, 'n', c(3,i(si(4)))]). % quicksort.c: l.11
...
ast_node(697, cond, [inf, +(i(si(4)),'top',c(2,i(si(4)))), *(i(si(4)),c(3,i(si(4))),c(2,i(si(4))))]). % quicksort.c: l.62
...
ast_node(686, cond, [inf, +(i(si(4)),'top',c(2,i(si(4)))), *(i(si(4)),c(3,i(si(4))),c(2,i(si(4))))]). % quicksort.c: l.56
