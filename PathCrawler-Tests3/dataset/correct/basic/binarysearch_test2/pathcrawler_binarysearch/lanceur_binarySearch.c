...
int main(int pathcrawler_argc, char *pathcrawler_argv[])
{
  ...
  {/* start global loop, one iteration for each test case */
    ...
    {/* start values loop, reading variable values for current test case */ 
      ...
      if(pathcrawler_strcmp(pathcrawler_name,"g_x")==0 ){
        pathcrawler_scan(PATHCRAWLER_INT, &pathcrawler_d);
        if(pathcrawler_d<(-2147483647-1) || pathcrawler_d>2147483647)
          { pathcrawler_errormsg( "g_x out of range [%d,%d]\n",(-2147483647-1),2147483647);
            exit(0); }
        g_x = pathcrawler_d;
        Pre_g_x = pathcrawler_d;
        /* debug */ //pathcrawler_errormsg("g_x=%d\n",pathcrawler_d);
         continue;
      }

      if(pathcrawler_strcmp(pathcrawler_name,"g_r")==0 ){
        pathcrawler_scan(PATHCRAWLER_INT, &pathcrawler_d);
        if(pathcrawler_d<(-2147483647-1) || pathcrawler_d>2147483647)
          { pathcrawler_errormsg( "g_r out of range [%d,%d]\n",(-2147483647-1),2147483647);
            exit(0); }
        g_r = pathcrawler_d;
        Pre_g_r = pathcrawler_d;
        /* debug */ //pathcrawler_errormsg("g_r=%d\n",pathcrawler_d);
         continue;
      }

      if(pathcrawler_strcmp(pathcrawler_name,"g_l")==0 ){
        pathcrawler_scan(PATHCRAWLER_INT, &pathcrawler_d);
        if(pathcrawler_d<(-2147483647-1) || pathcrawler_d>2147483647)
          { pathcrawler_errormsg( "g_l out of range [%d,%d]\n",(-2147483647-1),2147483647);
            exit(0); }
        g_l = pathcrawler_d;
        Pre_g_l = pathcrawler_d;
        /* debug */ //pathcrawler_errormsg("g_l=%d\n",pathcrawler_d);
         continue;
      }

      if(pathcrawler_strcmp(pathcrawler_inds.name_base,"g_arr")==0 &&(pathcrawler_inds.num_inds == 1) &&(pathcrawler_inds.num_fields == 0) ){
        pathcrawler_scan(PATHCRAWLER_INT, &pathcrawler_d);
        if(pathcrawler_d<(-2147483647-1) || pathcrawler_d>2147483647)
          { pathcrawler_errormsg( "g_arr[%d] out of range [%d,%d]\n",pathcrawler_inds.tab_inds[0],(-2147483647-1),2147483647);
            exit(0); }
        g_arr[pathcrawler_inds.tab_inds[0]] = pathcrawler_d;
        Pre_g_arr[pathcrawler_inds.tab_inds[0]] = pathcrawler_d;
        /* debug */ //pathcrawler_errormsg("g_arr[%d]=%d\n",pathcrawler_inds.tab_inds[0],pathcrawler_d);
         continue;
      }

      if(pathcrawler_strcmp(pathcrawler_name,"x")==0 ){
        pathcrawler_scan(PATHCRAWLER_INT, &pathcrawler_d);
        if(pathcrawler_d<(-2147483647-1) || pathcrawler_d>2147483647)
          { pathcrawler_errormsg( "x out of range [%d,%d]\n",(-2147483647-1),2147483647);
            exit(0); }
        x = pathcrawler_d;
        Pre_x = pathcrawler_d;
        /* debug */ //pathcrawler_errormsg("x=%d\n",pathcrawler_d);
         continue;
      }

      if(pathcrawler_strcmp(pathcrawler_name,"r")==0 ){
        pathcrawler_scan(PATHCRAWLER_INT, &pathcrawler_d);
        if(pathcrawler_d<(-2147483647-1) || pathcrawler_d>2147483647)
          { pathcrawler_errormsg( "r out of range [%d,%d]\n",(-2147483647-1),2147483647);
            exit(0); }
        r = pathcrawler_d;
        Pre_r = pathcrawler_d;
        /* debug */ //pathcrawler_errormsg("r=%d\n",pathcrawler_d);
         continue;
      }

      if(pathcrawler_strcmp(pathcrawler_name,"l")==0 ){
        pathcrawler_scan(PATHCRAWLER_INT, &pathcrawler_d);
        if(pathcrawler_d<(-2147483647-1) || pathcrawler_d>2147483647)
          { pathcrawler_errormsg( "l out of range [%d,%d]\n",(-2147483647-1),2147483647);
            exit(0); }
        l = pathcrawler_d;
        Pre_l = pathcrawler_d;
        /* debug */ //pathcrawler_errormsg("l=%d\n",pathcrawler_d);
         continue;
      }
...
void pathcrawler_call_fonction(void){
      #define main pathcrawler___main
      pathcrawler__retres__binarySearch = binarySearch(arr, l, r, x);
#undef main
}

void pathcrawler_call_oracle(void){
      oracle_binarySearch(Pre_arr, arr, l, r, x, pathcrawler__retres__binarySearch);
}
