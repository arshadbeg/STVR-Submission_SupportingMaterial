...
local_var('__tmp_lin_0', 'binarySearch_wrapper', i(si(4))).
local_var('i', 'binarySearch_wrapper', i(si(4))).
local_var('__retres', 'binarySearch_wrapper', i(si(4))).
local_var('__tmp_lin_1', 'main', i(si(4))).
local_var('arr', 'main', t(i(si(4)),3)).
local_var('n', 'main', i(si(4))).
local_var('x_values', 'main', t(i(si(4)),3)).
local_var('i', 'main', i(si(4))).
local_var('x', 'main', i(si(4))).
local_var('res', 'main', i(si(4))).
...
formal_param('return value', 'binarySearch_wrapper', 0, i(si(4))).
formal_param('arr', 'binarySearch_wrapper', 1, p(i(si(4)))).
formal_param('l', 'binarySearch_wrapper', 2, i(si(4))).
formal_param('r', 'binarySearch_wrapper', 3, i(si(4))).
formal_param('x', 'binarySearch_wrapper', 4, i(si(4))).
formal_param('return value', 'main', 0, i(si(4))).
formal_param(0,0,0,0).

global_var('g_arr', t(i(si(4)),3)).
global_var('g_l', i(si(4))).
global_var('g_r', i(si(4))).
global_var('g_x', i(si(4))).
global_var(0,0).
