...
:- heading:setval_file_name('fizzbuzz.c').
:- heading:setval_base_name('fizzbuzz').
:- heading:setval_pathcrawler_directory('pathcrawler_fizzbuzz').
:- heading:setval_trace_directory('pathcrawler_trace_fizzbuzz').
...
formal_param('n', 'fizzBuzz', 1, i(si(4))).
