...
ast_node(136, assign, [count, c(1, i(si(4)))]).
...
ast_node(145, cond, [inf, e(+(p(i(si(4))), arr, i), c(0, i(si(4)))), target]).
ast_node(150, assign, [i, +(i(si(4)), i, c(1, i(si(4))))]).
ast_node(159, assign, [result, '__tmp_lin_0']).
ast_node(148, assign, [count, *(i(si(4)), count, e(+(p(i(si(4))), arr, i), c(0, i(si(4)))))]).
