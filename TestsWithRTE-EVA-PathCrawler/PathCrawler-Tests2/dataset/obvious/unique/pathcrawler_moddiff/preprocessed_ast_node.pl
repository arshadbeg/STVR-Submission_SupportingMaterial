...
ast_node(131, assign, [sum, +(i(si(4)), e(+(p(i(si(4))), arr, i), c(0, i(si(4)))), c(1, i(si(4))))]).
...
stmt_location(n(1), 'moddiff.c', 4, 0).
stmt_location(139, 'moddiff.c', 13, 0).
stmt_location(126, 'moddiff.c', 4, 0).
stmt_location(fun(192), 'moddiff.c', 2, 0).
stmt_location(fun(201), 'moddiff.c', 10, 0).
stmt_location(141, 'moddiff.c', 15, 0).
stmt_location(fun(183), 'FRAMAC_SHARE/pc/lib/lanceur_deb.h', 79, 0).
stmt_location(121, 'moddiff.c', 3, 0).
stmt_location(138, 'moddiff.c', 12, 0).
stmt_location(122, 'moddiff.c', 3, 0).
stmt_location(142, 'moddiff.c', 24, 0).
stmt_location(131, 'moddiff.c', 5, 0).
stmt_location(134, 'moddiff.c', 7, 0).
stmt_location(123, 'moddiff.c', 4, 1).
stmt_location(132, 'moddiff.c', 4, 2).
stmt_location(140, 'moddiff.c', 15, 0).
stmt_location(136, 'moddiff.c', 11, 1).
stmt_location(137, 'moddiff.c', 11, 2).
stmt_location(i(1), 'moddiff.c', 11, 1).
stmt_location(i(2), 'moddiff.c', 11, 2).
stmt_location(i(3), 'moddiff.c', 11, 3).
stmt_location(i(4), 'moddiff.c', 11, 4).
stmt_location(i(5), 'moddiff.c', 11, 5).
