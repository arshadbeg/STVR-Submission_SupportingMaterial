...
ast_node(fun(194), func, [main, 0, 0, 1, 130]).
...
ast_node(fun(187), func, [hammingDistance, 2, 0, 1, 115]).
...
ast_supernode(130, fun(194), 0, fun(194)).
ast_supernode(115, fun(187), 0, fun(187)).
ast_supernode(131, 130, 0, fun(194)).
ast_supernode(132, 130, 1, fun(194)).
ast_supernode(133, 130, 2, fun(194)).
ast_supernode(134, 130, 3, fun(194)).
ast_supernode(135, 130, 4, fun(194)).
ast_supernode(n(1), 115, 2, fun(187)).
ast_supernode(n(2), n(1), body, fun(187)).
ast_supernode(125, n(2), 0, fun(187)).
ast_supernode(126, n(2), 1, fun(187)).
ast_supernode(116, 115, 0, fun(187)).
ast_supernode(117, 115, 1, fun(187)).
ast_supernode(128, 115, 3, fun(187)).
ast_supernode(120, n(1), cond, fun(187)).
...
stmt_location(n(2), 'hamming.c', 5, 0).
stmt_location(126, 'hamming.c', 6, 0).
stmt_location(fun(178), 'FRAMAC_SHARE/pc/lib/lanceur_deb.h', 79, 0).
stmt_location(135, 'hamming.c', 18, 0).
stmt_location(fun(194), 'hamming.c', 11, 0).
stmt_location(115, 'hamming.c', 2, 0).
stmt_location(133, 'hamming.c', 15, 0).
stmt_location(116, 'hamming.c', 2, 0).
stmt_location(131, 'hamming.c', 12, 0).
stmt_location(fun(187), 'hamming.c', 1, 0).
stmt_location(134, 'hamming.c', 15, 0).
stmt_location(132, 'hamming.c', 13, 0).
stmt_location(120, 'hamming.c', 4, 0).
stmt_location(117, 'hamming.c', 3, 0).
stmt_location(130, 'hamming.c', 12, 0).
stmt_location(128, 'hamming.c', 8, 0).
