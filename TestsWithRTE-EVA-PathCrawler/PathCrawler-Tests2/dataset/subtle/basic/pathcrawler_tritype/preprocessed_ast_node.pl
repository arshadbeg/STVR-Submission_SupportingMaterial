ast_supernode(323, n(2), 0, fun(192)).
ast_supernode(324, n(2), 1, fun(192)).
ast_supernode(364, 362, 1, fun(200)).
ast_supernode(377, 362, 4, fun(200)).
ast_supernode(337, n(12), 0, fun(192)).
ast_supernode(338, n(12), 1, fun(192)).
ast_supernode(374, n(42), 1, fun(200)).
ast_supernode(368, n(41), cond, fun(200)).
...
stmt_location(n(41), 'tritype.c', 29, 0).
...
stmt_location(359, 'tritype.c', 13, 0).
stmt_location(fun(192), 'tritype.c', 2, 0).
stmt_location(347, 'tritype.c', 9, 0).
stmt_location(364, 'tritype.c', 27, 0).
stmt_location(357, 'tritype.c', 12, 0).
stmt_location(344, 'tritype.c', 9, 0).
stmt_location(n(12), 'tritype.c', 7, 0).
stmt_location(fun(183), 'FRAMAC_SHARE/pc/lib/lanceur_deb.h', 79, 0).
stmt_location(377, 'tritype.c', 34, 0).
stmt_location(374, 'tritype.c', 30, 0).
stmt_location(324, 'tritype.c', 5, 0).
stmt_location(n(42), 'tritype.c', 30, 0).
stmt_location(342, 'tritype.c', 8, 0).
stmt_location(309, 'tritype.c', 3, 0).
stmt_location(323, 'tritype.c', 5, 0).
stmt_location(338, 'tritype.c', 7, 0).
stmt_location(368, 'tritype.c', 29, 0).
stmt_location(337, 'tritype.c', 7, 0).
stmt_location(365, 'tritype.c', 29, 1).
stmt_location(375, 'tritype.c', 29, 2).
stmt_location(339, 'tritype.c', 8, 0).
stmt_location(fun(200), 'tritype.c', 16, 0).
stmt_location(373, 'tritype.c', 30, 0).
stmt_location(354, 'tritype.c', 11, 0).
stmt_location(325, 'tritype.c', 6, 1).
stmt_location(330, 'tritype.c', 6, 2).
stmt_location(333, 'tritype.c', 6, 3).
stmt_location(311, 'tritype.c', 4, 1).
stmt_location(349, 'tritype.c', 10, 0).
stmt_location(310, 'tritype.c', 3, 0).
stmt_location(352, 'tritype.c', 10, 0).
stmt_location(316, 'tritype.c', 4, 2).
stmt_location(319, 'tritype.c', 4, 3).
stmt_location(362, 'tritype.c', 19, 1).
stmt_location(363, 'tritype.c', 19, 2).
stmt_location(i(1), 'tritype.c', 19, 1).
stmt_location(i(2), 'tritype.c', 19, 2).
stmt_location(i(3), 'tritype.c', 19, 3).
stmt_location(i(4), 'tritype.c', 19, 4).
stmt_location(i(5), 'tritype.c', 19, 5).
stmt_location(i(6), 'tritype.c', 19, 6).
stmt_location(i(7), 'tritype.c', 19, 7).
stmt_location(i(8), 'tritype.c', 19, 8).
stmt_location(i(9), 'tritype.c', 19, 9).
stmt_location(i(10), 'tritype.c', 19, 10).
stmt_location(i(11), 'tritype.c', 19, 11).
stmt_location(i(12), 'tritype.c', 19, 12).
stmt_location(i(13), 'tritype.c', 19, 13).
stmt_location(i(14), 'tritype.c', 19, 14).
stmt_location(i(15), 'tritype.c', 19, 15).
