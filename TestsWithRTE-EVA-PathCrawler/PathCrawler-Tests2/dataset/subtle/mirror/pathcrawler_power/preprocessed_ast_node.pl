...
ast_node(fun(186), func, [isPowerOfTwo, 1, 0, 1, 144]).
...
ast_node(158, assign, [numTests, c(15, i(si(4)))]).
...
ast_node(fun(190), func, [main, 0, 0, 1, 156]).
...
ast_supernode(144, fun(186), 0, fun(186)).
ast_supernode(n(1), 144, 0, fun(186)).
ast_supernode(154, 144, 1, fun(186)).
ast_supernode(156, fun(190), 0, fun(190)).
ast_supernode(n(4), n(1), cond, fun(186)).
ast_supernode(145, n(4), 0, fun(186)).
ast_supernode(149, n(4), 1, fun(186)).
ast_supernode(159, 156, 2, fun(190)).
ast_supernode(n(9), 156, 3, fun(190)).
ast_supernode(157, 156, 0, fun(190)).
ast_supernode(i(8), 157, 7, fun(190)).
ast_supernode(i(2), 157, 1, fun(190)).
ast_supernode(i(7), 157, 6, fun(190)).
ast_supernode(i(13), 157, 12, fun(190)).
ast_supernode(i(12), 157, 11, fun(190)).
ast_supernode(i(9), 157, 8, fun(190)).
ast_supernode(i(11), 157, 10, fun(190)).
ast_supernode(i(10), 157, 9, fun(190)).
ast_supernode(i(15), 157, 14, fun(190)).
ast_supernode(i(6), 157, 5, fun(190)).
ast_supernode(i(14), 157, 13, fun(190)).
ast_supernode(i(3), 157, 2, fun(190)).
ast_supernode(i(5), 157, 4, fun(190)).
ast_supernode(i(4), 157, 3, fun(190)).
ast_supernode(i(1), 157, 0, fun(190)).
ast_supernode(151, n(1), then, fun(186)).
ast_supernode(170, n(9), action, fun(190)).
ast_supernode(153, n(1), else, fun(186)).
ast_supernode(n(10), n(9), body, fun(190)).
ast_supernode(168, n(10), 1, fun(190)).
ast_supernode(167, n(10), 0, fun(190)).
ast_supernode(169, n(10), 2, fun(190)).
ast_supernode(158, 156, 1, fun(190)).
ast_supernode(172, 156, 4, fun(190)).
ast_supernode(162, n(9), cond, fun(190)).
...
stmt_location(n(4), 'power.c', 2, 0).
stmt_location(n(9), 'power.c', 10, 0).
stmt_location(n(1), 'power.c', 2, 0).
stmt_location(169, 'power.c', 12, 0).
stmt_location(fun(186), 'power.c', 1, 0).
stmt_location(168, 'power.c', 12, 0).
stmt_location(fun(177), 'FRAMAC_SHARE/pc/lib/lanceur_deb.h', 79, 0).
stmt_location(n(10), 'power.c', 11, 0).
stmt_location(158, 'power.c', 8, 0).
stmt_location(151, 'power.c', 2, 1).
stmt_location(153, 'power.c', 2, 2).
stmt_location(154, 'power.c', 2, 0).
stmt_location(144, 'power.c', 2, 1).
stmt_location(167, 'power.c', 11, 0).
stmt_location(fun(190), 'power.c', 5, 0).
stmt_location(145, 'power.c', 2, 1).
stmt_location(149, 'power.c', 2, 2).
stmt_location(162, 'power.c', 10, 0).
stmt_location(159, 'power.c', 10, 1).
stmt_location(170, 'power.c', 10, 2).
stmt_location(172, 'power.c', 16, 0).
stmt_location(156, 'power.c', 7, 1).
stmt_location(157, 'power.c', 7, 2).
