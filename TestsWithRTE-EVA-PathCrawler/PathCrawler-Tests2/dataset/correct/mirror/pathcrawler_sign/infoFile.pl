...
:- heading:setval_file_name('sign.c').
:- heading:setval_base_name('sign').
:- heading:setval_pathcrawler_directory('pathcrawler_sign').
:- heading:setval_trace_directory('pathcrawler_trace_sign').
...
local_var('__tmp_lin_1', 'sign', i(si(4))).
local_var('__tmp_lin_0', 'sign', i(si(4))).
local_var('__retres', 'sign', i(si(4))).
local_var('__tmp_lin_2', 'main', i(si(4))).
local_var('testValues', 'main', t(i(si(4)),7)).
...
formal_param('return value', 'sign', 0, i(si(4))).
formal_param('n', 'sign', 1, i(si(4))).
