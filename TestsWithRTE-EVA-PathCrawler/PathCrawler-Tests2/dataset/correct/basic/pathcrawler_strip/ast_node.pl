...
ast_node(147, assign, [e(+(p(i(si(1))),'str','__tmp_lin_0'),c(0,i(si(4)))), e(+(p(i(si(1))),'str','i'),c(0,i(si(4))))]). % strip.c: l.6
...
ast_node(141, cond, [diff, cast(i(si(4)),e(+(p(i(si(1))),'str','i'),c(0,i(si(4))))), c(32,i(si(4)))]). % strip.c: l.5
ast_node(fun(170), func, ['__FC_assert', 4, 0, 0, 127]). % FRAMAC_SHARE/pc/lib/lanceur_deb.h: l.79
ast_node(136, cond, [diff, e(+(p(i(si(1))),'str','i'),c(0,i(si(4)))), 0]). % strip.c: l.4
ast_node(151, assign, [e(+(p(i(si(1))),'str','j'),c(0,i(si(4)))), cast(i(si(1)),c(0,i(si(4))))]). % strip.c: l.10
ast_node(154, seq, [155,156]). % strip.c: l.13
ast_node(149, assign, ['i', +(i(si(4)),'i',c(1,i(si(4))))]). % strip.c: l.8
ast_node(133, assign, ['j', c(0,i(si(4)))]). % strip.c: l.3
ast_node(156, return, ['__retres']). % strip.c: l.13
ast_node(155, assign, ['__retres', c(0,i(si(4)))]). % strip.c: l.13
...
ast_node(fun(185), func, ['main', 0, 0, 1, 154]). % strip.c: l.13
