...
ast_node(150, assign, ['n', cast(i(si(4)),/(i(us(8)),c(20,i(si(4))),c(4,i(si(4)))))]). % max.c: l.12
ast_node(n(3), seq, [144]). % max.c: l.3
ast_node(134, cond, [inf, 'i', 'n']). % max.c: l.3
...
ast_node(130, assign, ['max', e(+(p(i(si(4))),'arr',c(0,i(si(4)))),c(0,i(si(4))))]). % max.c: l.2
