...
/* reinitialize static and global variables */
    pathcrawler_init();
...
void pathcrawler_call_fonction(void){
      #define main pathcrawler___main
      pathcrawler__retres__main = main();
#undef main
}

void pathcrawler_call_oracle(void){
      oracle_main(pathcrawler__retres__main);
}
