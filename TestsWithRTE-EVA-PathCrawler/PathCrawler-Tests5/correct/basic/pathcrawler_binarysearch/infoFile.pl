...
local_var('low', 'binarySearch', i(si(4))).
local_var('high', 'binarySearch', i(si(4))).
local_var('mid', 'binarySearch', i(si(4))).
...
formal_param('size', 'binarySearch', 2, i(si(4))).
formal_param('target', 'binarySearch', 3, i(si(4))).
