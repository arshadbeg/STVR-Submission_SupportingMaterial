...
dom('binarySearch',e('arr',_),[],int([-2147483648..2147483647])).
% add new array domain e.g.:
%  dom('yourFunName',e('yourArray',_),[],int([min..max])).

create_input_vals('binarySearch',Ins):-
  create_input_val('target',int([-2147483648..2147483647]),Ins),
  create_input_val('size',int([-2147483648..2147483647]),Ins),
  create_input_val(dim('arr'),int([0..1]),Ins),
...
unquantif_preconds('binarySearch',[]).

quantif_preconds('binarySearch',[]).
