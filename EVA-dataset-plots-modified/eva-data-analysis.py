...
# 3. Alarm types frequency (legend outside)
...
ax = alarm_counts.plot(kind="bar", stacked=True, figsize=(8,5))

# Move legend outside the plot
ax.legend(title="Alarm Types", bbox_to_anchor=(1.05, 1), loc='upper left')

ax.set_title("Distribution of Alarm Types by Category")
ax.set_ylabel("Count")
