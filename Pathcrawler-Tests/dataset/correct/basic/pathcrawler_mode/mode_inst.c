...
int findMode(int *arr, int size)
{
  ...
  while (1) {
    if (i < size) {
      pathcrawler_trace_full("+193","l.4, file mode.c");
      goto lin_for_body_2;
    }
    else {
      pathcrawler_trace_full("-193","l.4, file mode.c");
    ...
    lin_for_body_2:
    {
      ...
      while (1) {
        if (j < size) {
          pathcrawler_trace_full("+202","l.6, file mode.c");
          goto lin_for_body_7;
        }
        else {
          pathcrawler_trace_full("-202","l.6, file mode.c");
        ...
        if (*(arr + j % 10) == *(arr + i % 10)) {
          pathcrawler_trace_full("+207","l.7, file mode.c");
      ...
      lin_for_break_6: ;
      if (count > maxCount) {
        pathcrawler_trace_full("+215","l.11, file mode.c");
        lin_ite_body_17: {
                           maxCount = count;
                           mode = *(arr + i % 10);
                         }
