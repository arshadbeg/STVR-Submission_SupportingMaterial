...
ast_node(147, assign, [e(+(p(i(si(1))), str, mod(i(si(4)), '__tmp_lin_0', c(10, i(si(4))))), c(0, i(si(4)))), e(+(p(i(si(1))), str, mod(i(si(4)), i, c(10, i(si(4))))), c(0, i(si(4))))]).
ast_node(146, assign, [j, +(i(si(4)), j, c(1, i(si(4))))]).
ast_node(fun(179), func, [stripSpaces, 1, 0, 0, 131]).
ast_node(141, cond, [diff, cast(i(si(4)), e(+(p(i(si(1))), str, mod(i(si(4)), i, c(10, i(si(4))))), c(0, i(si(4))))), c(32, i(si(4)))]).
ast_node(136, cond, [diff, e(+(p(i(si(1))), str, mod(i(si(4)), i, c(10, i(si(4))))), c(0, i(si(4)))), 0]).
ast_node(151, assign, [e(+(p(i(si(1))), str, mod(i(si(4)), j, c(10, i(si(4))))), c(0, i(si(4)))), cast(i(si(1)), c(0, i(si(4))))]).
...
stmt_location(155, 'strip.c', 14, 0).
...
stmt_location(fun(185), 'strip.c', 14, 0).
